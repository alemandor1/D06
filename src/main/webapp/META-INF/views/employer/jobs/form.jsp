...
<acme:form readonly="${status == 'PUBLISHED' and command == 'show'}">
	...
	<acme:form-submit test="${command == 'show' and status == 'PUBLISHED'}" code="employer.job.form.button.list-audits-job" action="/employer/audit-record/list-audits-job?idJob=${id}" method="get"/>
