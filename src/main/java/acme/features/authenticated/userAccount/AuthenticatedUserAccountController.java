...
public class AuthenticatedUserAccountController extends AbstractController<Authenticated, UserAccount> {
	...
	private void initialise() {
		...
		super.addCustomCommand(CustomCommand.LIST_INVOLVED_USERS, BasicCommand.LIST, this.listService);
		super.addCustomCommand(CustomCommand.LIST_NOT_INVOLVED_USERS, BasicCommand.LIST, this.listService);
	}
